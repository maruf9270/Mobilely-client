...
const Signup = () => {
  ...
  const { signUpWithEmail, update, logOut, signWithGoogle } =
        ...
        >
          ...
          <div className="space-y-1 text-sm">
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-md bg-gray-50 text-gray-800 border focus:border-violet-600 ${
                passfieldError || confirmPassError
                  ? "border-red-700"
                  : "border-gray-300"
              }`}
              required
          ...
          <div className="space-y-1 text-sm">
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-md bg-gray-50 text-gray-800 focus:border-violet-600 border ${
                confirmPassError ? "border-red-700" : "border-gray-300"
              }`}
              required
            />
            <div className="flex justify-end text-xs text-gray-600"></div>
          ...
          <select
            name="option"
            id="option"
            className="w-52 rounded border border-stone-300"
            required
          >
            <option value="buyer" className="default">
              Buyer
            </option>

...
const ReportedItems = () => {
    ...
    return (
        <div className='border border-stone-300 w-[98%] md:p-5 rounded-md md:mx-4 sm:mx-auto'>
            ...
            {
                isLoading ? <SmallSpinner></SmallSpinner>: reportedItems.length > 0 ? <ProsuctTable reportedItems={reportedItems} setDelete={setDelete}></ProsuctTable>:
                <div className='text-3xl font-bold text-center'>No Reported Item Found</div>
            }
